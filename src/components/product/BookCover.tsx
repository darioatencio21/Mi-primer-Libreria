...
function buildSrc(isbn?: string, coverImage?: string, title?: string, author?: string): string {
...
export function BookCover({
  ...
  const [src, setSrc] = useState<string>(() => buildSrc(isbn, coverImage, title, author))
