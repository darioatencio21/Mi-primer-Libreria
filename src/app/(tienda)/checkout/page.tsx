...
const ORDER_ITEMS = [
  { id: '1', title: 'Cien años de soledad', format: 'Tapa blanda', quantity: 1, price: 19.99, coverImage: '/placeholder-book.svg' },
  { id: '3', title: 'Kafka en la orilla', format: 'Tapa dura', quantity: 2, price: 26.99, coverImage: '/placeholder-book.svg' },
]
                ...
                <div className="bg-bg-muted rounded-[var(--radius-md)] p-[var(--space-6)] max-w-[480px] mx-auto mb-[var(--space-8)]">
                  <div className="flex flex-col gap-[var(--space-3)]">
                    {ORDER_ITEMS.map((item) => (
                      <div key={item.id} className="flex items-center gap-[var(--space-3)]">
                        <div className="w-12 h-16 rounded-[var(--radius-sm)] bg-bg-surface overflow-hidden relative shrink-0">
                          <Image src={item.coverImage} alt="" fill sizes="48px" className="object-contain p-1" />
                        </div>
